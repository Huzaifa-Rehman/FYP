      ...
      appBar: AppBar(
        ...
        actions: [
          TextButton(
            ...
            child: const Text("Read All", style: TextStyle(color: AppColors.primaryGreen, fontWeight: FontWeight.bold)),
          ),
          IconButton(
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          notifications.sort((a, b) {
            ...
            final aTime = (aData['created_at'] as Timestamp?)?.toDate() ?? DateTime(0);
            final bTime = (bData['created_at'] as Timestamp?)?.toDate() ?? DateTime(0);
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                GestureDetector(
                                  onTap: () => _deleteNotification(notifications[index].id),
