...
class _AddProductScreenState extends State<AddProductScreen> {
  ...
  Future<void> _submit() async {
    ...
    try {
      print('AddProductScreen: Starting submission...');
      
      // Upload image if a new one is picked
      if (_pickedImageBytes != null) {
        print('AddProductScreen: Uploading image...');
        ...
        print('AddProductScreen: Image uploaded: $imageUrl');
      }

      if (imageUrl == null || imageUrl.isEmpty) {
        print('AddProductScreen: No image URL provided');
        if (mounted) {
      ...
      print('AddProductScreen: Saving product data...');
      ...
      print('AddProductScreen: Success!');
      if (mounted) {
      ...
      print('AddProductScreen: Error during submission: $e');
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
      ...
      print('AddProductScreen: Submission process finished.');
              ...
              child: Column(
                ...
                children: [
                  _buildTextField(_nameController, "Product Name", "e.g. Fresh Tomatoes", Icons.shopping_basket,
                    validator: (val) {
                      if (val == null || val.trim().isEmpty) return "Please enter a product name";
