...
class _SignupScreenState extends State<SignupScreen> {
  ...
  Future<void> _signUp() async {
    ...
    try {
      ...
      print('SignupScreen: General Exception: $e');
  ...
  Future<void> _loginWithGoogle() async {
    ...
    try {
      ...
      print('SignupScreen: Google Sign-In Error: $e');
                ...
                child: Center(
                  child: ConstrainedBox(
                    ...
                    _buildInputField(
                      ...
                      isPassword: true,
                      textInputAction: _roles[_selectedRoleIndex] == 'Customer' ? TextInputAction.done : TextInputAction.next,
                      onSubmitted: _roles[_selectedRoleIndex] == 'Customer' ? (_) => _signUp() : null,
                    ),
                    const SizedBox(height: 20),
