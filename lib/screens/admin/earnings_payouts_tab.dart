              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text('Earned: Rs. ${owedToRider.toStringAsFixed(0)} | Collected COD: Rs. ${cashToCollect.toStringAsFixed(0)}', style: const TextStyle(fontSize: 12)),
                  ],
                ),
              ),
              Column(
                ...
                children: [
                  ...
                  Text('Rs. ${netOwedToAdmin.abs().toStringAsFixed(0)}', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16, color: isRiderOwesAdmin ? Colors.red : Colors.blue)),
                ],
              ),
              const SizedBox(width: 16),
              ElevatedButton(
